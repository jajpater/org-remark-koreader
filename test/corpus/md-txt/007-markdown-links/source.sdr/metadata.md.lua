-- /home/jajpater/Develop/mygithub/koreader-fixtures/corpus/.work/staged/007-markdown-links/source.sdr/metadata.md.lua
return {
    ["annotations"] = {
        [1] = {
            ["chapter"] = "Markdown links",
            ["color"] = "green",
            ["datetime"] = "2026-08-15 13:07:09",
            ["datetime_updated"] = "2026-08-15 13:07:09",
            ["drawer"] = "lighten",
            ["note"] = "Selection crosses both link boundaries.",
            ["page"] = "/html/body/p/text()[1].0",
            ["pageno"] = 1,
            ["pos0"] = "/html/body/p/text()[1].0",
            ["pos1"] = "/html/body/p/text()[2].10",
            ["text"] = "Read the linked passage carefully",
        },
        [2] = {
            ["chapter"] = "Markdown links",
            ["color"] = "yellow",
            ["datetime"] = "2026-08-15 13:07:09",
            ["drawer"] = "lighten",
            ["page"] = "/html/body/p/a/text().0",
            ["pageno"] = 1,
            ["pos0"] = "/html/body/p/a/text().0",
            ["pos1"] = "/html/body/p/a/text().18",
            ["text"] = "the linked passage",
        },
    },
    ...
    ["css"] = "./data/epub.css",
    ["doc_pages"] = 1,
    ["doc_path"] = "/home/jajpater/Develop/mygithub/koreader-fixtures/corpus/.work/staged/007-markdown-links/source.md",
    ["doc_props"] = {
        ["title"] = "source",
    },
    ...
    ["partial_md5_checksum"] = "ca59480e6c04667a9099de2b3c4f7c01",

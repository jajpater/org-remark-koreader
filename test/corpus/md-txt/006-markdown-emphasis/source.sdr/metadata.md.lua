...
return {
    ["annotations"] = {
        [1] = {
            ["chapter"] = "Markdown emphasis",
            ["color"] = "purple",
            ["datetime"] = "2026-08-15 13:07:02",
            ["datetime_updated"] = "2026-08-15 13:07:02",
            ["drawer"] = "lighten",
            ["note"] = "Range spans the complete formatted phrase.",
            ["page"] = "/html/body/p[1]/text()[1].0",
            ["pageno"] = 1,
            ["pos0"] = "/html/body/p[1]/text()[1].0",
            ["pos1"] = "/html/body/p[1]/text()[2].14",
            ["text"] = "This contains bold words in a sentence",
        },
        [2] = {
            ["chapter"] = "Markdown emphasis",
            ["color"] = "yellow",
            ["datetime"] = "2026-08-15 13:07:02",
            ["drawer"] = "lighten",
            ["page"] = "/html/body/p[1]/strong/text().0",
            ["pageno"] = 1,
            ["pos0"] = "/html/body/p[1]/strong/text().0",
            ["pos1"] = "/html/body/p[1]/strong/text().10",
            ["text"] = "bold words",
        },
        [3] = {
            ["chapter"] = "Markdown emphasis",
            ...
            ["datetime"] = "2026-08-15 13:07:02",
            ["drawer"] = "lighten",
            ["page"] = "/html/body/p[2]/text()[1].5",
            ["pageno"] = 1,
            ["pos0"] = "/html/body/p[2]/text()[1].5",
            ["pos1"] = "/html/body/p[2]/em/text().12",
            ["text"] = "contains italic words",
        },
    },
    ...
    ["partial_md5_checksum"] = "7d97d20c412289268fa4c88e790d1e1c",

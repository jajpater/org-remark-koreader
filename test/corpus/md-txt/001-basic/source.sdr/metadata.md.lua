-- /home/jajpater/Develop/mygithub/koreader-fixtures/corpus/.work/staged/001-basic/source.sdr/metadata.md.lua
return {
    ["annotations"] = {
        [1] = {
            ["chapter"] = "Basic fixture",
            ["color"] = "yellow",
            ["datetime"] = "2026-08-15 13:06:31",
            ["drawer"] = "lighten",
            ["page"] = "/html/body/p[1]/text().26",
            ["pageno"] = 1,
            ["pos0"] = "/html/body/p[1]/text().26",
            ["pos1"] = "/html/body/p[1]/text().51",
        ...
        [2] = {
            ...
            ["color"] = "green",
            ["datetime"] = "2026-08-15 13:06:31",
            ["datetime_updated"] = "2026-08-15 13:06:31",
            ["drawer"] = "lighten",
            ["note"] = "This annotation was generated by corpusgen.",
            ["page"] = "/html/body/p[2]/text().24",
            ["pageno"] = 1,
            ["pos0"] = "/html/body/p[2]/text().24",
            ["pos1"] = "/html/body/p[2]/text().65",
            ["text"] = "another sentence that will receive a note",
        },
        [3] = {
            ["chapter"] = "Basic fixture",
            ["datetime"] = "2026-08-15 13:06:31",
            ["page"] = "/html/body/p[17]/text().0",
            ["pageno"] = 2,
            ["text"] = "in Basic fixture",
        },
    },
    ...
    ["css"] = "./data/epub.css",
    ["doc_pages"] = 2,
    ["doc_path"] = "/home/jajpater/Develop/mygithub/koreader-fixtures/corpus/.work/staged/001-basic/source.md",
    ["doc_props"] = {
        ["title"] = "source",
    },
    ...
    ["last_xpointer"] = "/html/body/p[23]/text().0",
    ["page_overlap_style"] = "dim",
    ["partial_md5_checksum"] = "bddb469199955cee0dc9d2960720782b",

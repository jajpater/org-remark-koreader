-- /home/jajpater/Develop/mygithub/koreader-fixtures/corpus/.work/staged/005-duplicates/source.sdr/metadata.md.lua
return {
    ["annotations"] = {
        [1] = {
            ["chapter"] = "Duplicate fixture",
            ["color"] = "yellow",
            ["datetime"] = "2026-08-15 13:06:56",
            ["drawer"] = "lighten",
            ["page"] = "/html/body/p[1]/text().0",
            ["pageno"] = 1,
            ["pos0"] = "/html/body/p[1]/text().0",
            ["pos1"] = "/html/body/p[1]/text().47",
            ["text"] = "Repeated sentence for deterministic occurrence.",
        },
        [2] = {
            ["chapter"] = "Duplicate fixture",
            ["color"] = "green",
            ["datetime"] = "2026-08-15 13:06:56",
            ["drawer"] = "lighten",
            ["page"] = "/html/body/p[3]/text().0",
            ["pageno"] = 1,
            ["pos0"] = "/html/body/p[3]/text().0",
            ["pos1"] = "/html/body/p[3]/text().47",
            ["text"] = "Repeated sentence for deterministic occurrence.",
        },
        [3] = {
            ["chapter"] = "Duplicate fixture",
            ...
            ["datetime"] = "2026-08-15 13:06:56",
            ["drawer"] = "lighten",
            ["page"] = "/html/body/p[5]/text().0",
            ["pageno"] = 1,
            ["pos0"] = "/html/body/p[5]/text().0",
            ["pos1"] = "/html/body/p[5]/text().47",
            ["text"] = "Repeated sentence for deterministic occurrence.",
        },
    },
    ...
    ["css"] = "./data/epub.css",
    ["doc_pages"] = 1,
    ["doc_path"] = "/home/jajpater/Develop/mygithub/koreader-fixtures/corpus/.work/staged/005-duplicates/source.md",
    ["doc_props"] = {
        ["title"] = "source",
    },
    ...
    ["partial_md5_checksum"] = "eafbe494c9924f38de71657f71d917b1",

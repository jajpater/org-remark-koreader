-- /home/jajpater/Develop/mygithub/koreader-fixtures/corpus/.work/staged/004-multiline/source.sdr/metadata.md.lua
return {
    ["annotations"] = {
        [1] = {
            ["chapter"] = "Multiline fixture",
            ["color"] = "yellow",
            ["datetime"] = "2026-08-15 13:06:50",
            ["drawer"] = "lighten",
            ["page"] = "/html/body/p/text().2",
            ["pageno"] = 1,
            ["pos0"] = "/html/body/p/text().2",
            ["pos1"] = "/html/body/p/text().88",
            ["text"] = "soft-wrapped logical paragraph begins here and continues across a Markdown source line",
        },
        [2] = {
            ["chapter"] = "Multiline fixture",
            ["color"] = "green",
            ["datetime"] = "2026-08-15 13:06:50",
            ["datetime_updated"] = "2026-08-15 13:06:50",
            ["drawer"] = "lighten",
            ["note"] = "Rendered selection contains a physical newline.",
            ["page"] = "/html/body/pre/code/text().0",
            ["pageno"] = 1,
            ["pos0"] = "/html/body/pre/code/text().0",
            ["pos1"] = "/html/body/pre/code/text().30",
            ["text"] = "alpha code line\
beta code line",
        },
    },
    ...
    ["css"] = "./data/epub.css",
    ["doc_pages"] = 1,
    ["doc_path"] = "/home/jajpater/Develop/mygithub/koreader-fixtures/corpus/.work/staged/004-multiline/source.md",
    ["doc_props"] = {
        ["title"] = "source",
    },
    ...
    ["partial_md5_checksum"] = "1f4ce20bbf23cbb48b10782c24b38104",
